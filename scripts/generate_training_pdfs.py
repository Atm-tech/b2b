...
make_pdf("05_Delivery_Collection_Guide.pdf", "DELIVERY + COLLECTION - WHATSAPP", "For: One Delivery and Collection Agent", "WhatsApp par assigned DCO dekhna, proof ke saath delivery karna aur permitted collection record karna.", "Aap ek hi agent ho. Command READ se shuru karo; delivery ke baad wahi collection command use hogi.", [
    ...
    ("Collection from WhatsApp", "Buttons sirf retailer ke approved privileges ke hisaab se dikhte hain.", ["Allowed ho to Collect now ya Collect later choose karo.", "Collect now par Full/Partial sirf approved retailer ke liye aayega.", "Cash/UPI/Cheque options mein cheque sirf privileged retailer ko milega.", "Cash: denominations type karo: CASH task stop 500x0 200x0 100x0 50x0 20x0 10x0 COINSx0.", "UPI: QR aayega; payment proof photo bhejo.", "Cheque: cheque photo bhejo.", "System amount aur tolerance check karke collection record karega."], ("stop", "Money safety", "Short cash, unauthorised cheque ya proof missing ho to collection record mat karo; Contact WhatsApp Admin.")),
