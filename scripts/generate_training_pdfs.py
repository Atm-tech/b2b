...
make_pdf("04_Warehouse_IN_OUT_Guide.pdf", "WAREHOUSE - WHATSAPP IN / OUT", "For: Warehouse Manager", "WhatsApp se stock inward, sales dispatch aur DCO banana. Har action ka actual record B CONNECT mein banta hai.", "Apne registered WhatsApp se command type karo: IN, OUT, READY aur DCO.", [
    ...
    ("OUT - sales dispatch, DCO and handover", "Confirmed sales orders ko warehouse WhatsApp se ready karo, phir same warehouse ke multiple bills ek DCO mein bundle karke physically handover record karo.", ["OUT type karke ready sales orders dekho.", "Last digits se correct order choose karo: OUT 482516.", "Packed weight/photo bhejo.", "Type karo: READY 482516. Isse docket ready hota hai.", "2-4 ready orders ek route mein bhejne ho to type karo: DCO 482516,639104,774210.", "DCO ready rahega, lekin delivery agent ko abhi visible nahi hoga.", "Physical bundle agent ko dene ke baad type karo: HANDOVER 482516. Multiple DCO ke liye comma use karo.", "Reply mein handover success check karo; tab delivery agent ke LIST mein task aayega."], ("stop", "Do not dispatch", "Wrong retailer, missing weight photo, wrong quantity, ya different warehouse orders ko ek DCO mein mat bhejo.")),
