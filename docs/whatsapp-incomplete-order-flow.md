...
- An unresolved report protects the affected stop and prevents whole-trip completion, reassignment or removal of that stop. Other stops can still progress. Original quantities, stock and billing remain unchanged by reporting or seller authorization.
- Return Authorized remains open with custody assigned to the delivery agent. Warehouse receipt/counting, condition disposition and financial adjustment remain the subsequent return-resolution stage; seller authorization is not a stock receipt, invoice amendment or refund. Partial accepted-quantity and collection settlement are not inferred from a selected return quantity.
