...
- Return Authorized remains open with custody assigned to the delivery agent. The confirmed agent report records unreturned quantities as accepted by the retailer. Seller approval adjusts the invoice and immediately unlocks collection. Warehouse receipt/counting, condition disposition and refund verification remain subsequent stages; approval and collection never restore stock or close the return custody case.
